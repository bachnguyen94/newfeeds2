...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            ...
            <?= __('System');?>
            <span> > <?= $this->Html->link(__('List of Fashion'), ['action' => 'index'])?></span>
        </h1>
    </div>
</div>
    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2><h2><?= ($fashion->isNew())?__('Fashion add'):__('Fashion edit'); ?></h2></h2>
            </header>
            ...
            <div>
                ...
                <div class="widget-body">
                    ...
                    <?= $this->Form->create($fashion, ['id' => 'smart-form-register', 'class' => 'form-horizontal']) ?>
                    <fieldset>
                            ...
                            <div class="col-md-9">
                                <div class="prevIcon">
                                    ...
                                    foreach (explode(',', $fashion->imageUrl) as $image) {
                                        echo $this->Core->image('Fashions/'.$image, 64, 64, [], true, true);
                                    }
                                    ?>
                                </div>
