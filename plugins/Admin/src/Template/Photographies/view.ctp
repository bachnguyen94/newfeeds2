...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            ...
            <?= __('System');?>
            <span>&gt;
                <?= $this->Html->link(__('List of Photography'), ['action' => 'index'])?>
            </span>
        </h1>
    </div>
</div>
                    ...
                    <fieldset>
                        <table id="user" class="table table-bordered table-striped" style="clear: both">
                            ...
                            <tr>
                                ...
                                <td style="width:65%"><?= h($photography->title); ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('Description') ?></td>
                                <td style="width:65%"><?= h($photography->description) ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('Created') ?></td>
                                <td style="width:65%"><?= h($photography->created) ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </fieldset>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?= $this->Html->link(__('Edit'), ['action' => 'form', $photography->id], ['class' => 'btn btn-primary']) ?>
                            </div>
                        </div>
                    </div>
                </div>
