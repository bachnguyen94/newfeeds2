                    ...
                    <fieldset>
                        <table id="user" class="table table-bordered table-striped" style="clear: both">
                            ...
                            <tr>
                                ...
                                <td style="width:65%"><?= h($business->title); ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('Description') ?></td>
                                <td style="width:65%"><?= h($business->description) ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('Created') ?></td>
                                <td style="width:65%"><?= h($business->created) ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </fieldset>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?= $this->Html->link(__('Edit'), ['action' => 'form', $business->id], ['class' => 'btn btn-primary']) ?>
                            </div>
                        </div>
                    </div>
                </div>
