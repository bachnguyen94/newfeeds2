...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            ...
            <?= __('System');?>
            <span> > <?= $this->Html->link(__('List of Technology'), ['action' => 'index'])?></span>
        </h1>
    </div>
</div>
    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2><h2><?= ($technology->isNew())?__('Technology add'):__('Technology edit'); ?></h2></h2>
            </header>
            ...
            <div>
                ...
                <div class="widget-body">
                    ...
                    <?= $this->Form->create($technology, ['id' => 'smart-form-register', 'class' => 'form-horizontal']) ?>
                    <fieldset>
