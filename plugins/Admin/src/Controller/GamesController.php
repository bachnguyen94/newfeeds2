 ...
 * Games Controller
 *
 * @property \Admin\Model\Table\GamesTable $Games
 */
class GamesController extends AppController
{
    ...
    public function form($id = null)
    {
        ...
        if ($this->request->data) {
            $game = $this->Core->patchEntity($game, $this->request->data);
            if ($this->Games->save($game)) {
                $this->Flash->success(__('The Games has been saved.'));

                return $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->error(__('The Games could not be saved. Please, try again.'));
            }
        }
        $this->set(compact('game'));
        $this->set('_serialize', ['game']);
