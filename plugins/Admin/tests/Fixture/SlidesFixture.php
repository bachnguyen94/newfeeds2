...
class SlidesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tableName' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'record_id' => 1,
            'created' => '2016-11-18 15:53:59',
            'modified' => '2016-11-18 15:53:59'
        ],
    ];
}
