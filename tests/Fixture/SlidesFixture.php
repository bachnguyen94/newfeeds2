...
class SlidesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'table_name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'recordId' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'display_order' => 1,
            'status' => 1,
            'created' => '2016-11-20 01:39:00',
            'modified' => '2016-11-20 01:39:00'
        ],
    ];
}
